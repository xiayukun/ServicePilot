...
public sealed class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["LogFoldAll"] = "摘要",
        ["LogExpandAll"] = "展开",
        ["LogFoldAllTip"] = "折叠全部合并组，后续新日志组也保持折叠",
        ["LogExpandAllTip"] = "展开全部合并组，后续新日志组也保持展开",
        ["CloseActionLogTab"] = "关闭动作日志：{0}",
        ["CopySelected"] = "复制选中",
        ["CopyAll"] = "复制全部",
        ["CopyCommands"] = "复制命令",
        ["Close"] = "关闭",
        ...
        ["AiHelpIntro"] = "把下面内容复制给个人 AI 助手，AI 就能直接操作当前 ServicePilot。",
        ["Status"] = "状态",
        ["Name"] = "名称",
        ["Description"] = "说明",
        ["ServiceConfig"] = "服务配置",
        ...
        ["ScriptContent"] = "脚本内容",
        ["MergeFunction"] = "合并函数",
        ["MergeScriptCompileError"] = "合并函数「{0}」编译失败，已停用合并/折叠：{1}",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["LogFoldAll"] = "Summary",
        ["LogExpandAll"] = "Expand",
        ["LogFoldAllTip"] = "Fold every merge group and keep new log groups folded",
        ["LogExpandAllTip"] = "Expand every merge group and keep new log groups expanded",
        ["CloseActionLogTab"] = "Close action log: {0}",
        ...
        ["AiHelpIntro"] = "Copy the text below to your personal AI assistant so it can operate the current ServicePilot directly.",
        ["Status"] = "Status",
        ["Name"] = "Name",
        ...
        ["MergeFunction"] = "Merge function",
        ["MergeScriptCompileError"] = "Merge function \"{0}\" failed to compile; merge/collapse disabled: {1}",
