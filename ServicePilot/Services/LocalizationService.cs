...
public sealed class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["LogFoldAll"] = "摘要",
        ["LogExpandAll"] = "展开",
        ["LogFoldAllTip"] = "折叠全部合并组，只看摘要一行",
        ["LogExpandAllTip"] = "展开全部合并组，查看所有原始行",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["LogFoldAll"] = "Summary",
        ["LogExpandAll"] = "Expand",
        ["LogFoldAllTip"] = "Fold every merge group to a single summary line",
        ["LogExpandAllTip"] = "Expand every merge group to see all raw lines",
