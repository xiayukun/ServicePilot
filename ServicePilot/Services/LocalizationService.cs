...
public sealed class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["AddOneStepPrompt"] = "请至少添加一个脚本步骤。",
        ["StepContentRequired"] = "脚本步骤内容不能为空。",
        ["NoTemplatesAvailable"] = "还没有可用模板。可以从服务存为模板，或在模板管理中新增。",
        ["DefaultStepName"] = "步骤 {0}",
        ["UnnamedStep"] = "未命名步骤",
        ["PresetVariables"] = "预设变量",
        ["StartupVariablesHelp"] = "一行一个启动变量",
        ["ManualStepVariables"] = "手动执行变量",
        ["ManualStepVariablesHelp"] = "一行一个步骤变量",
        ["ManualStepVariablesTooltip"] = "仅用于当前不启动执行步骤。执行该步骤时可选择一个变量；它会注入为 SERVICEPILOT_VARIABLE，并替换脚本中的 {{variable}} / {{变量}}。",
        ["StartupVariablesTooltip"] = "用于启动执行步骤。启动、重启或执行启动步骤时可选择一个变量；它会注入为 SERVICEPILOT_VARIABLE，并替换脚本中的 {{variable}} / {{变量}}。",
        ...
        ["TrayStatusActive"] = "ServicePilot: {0}/{1} 运行中，{2} 失败 | {3}",
        ["EmptyVariable"] = "(空变量)",
        ["StateStopped"] = "已停止",
        ["StateStarting"] = "启动中",
        ["StateRunning"] = "运行中",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Apply"] = "Apply",
        ["TemplateSummary"] = "{0} steps, {1} variables",
        ["DeleteShort"] = "Del",
        ["StepName"] = "Step name",
        ...
        ["AddOneStepPrompt"] = "Add at least one script step.",
        ["StepContentRequired"] = "Script step content cannot be empty.",
        ["NoTemplatesAvailable"] = "No templates are available. Save a service as a template or add one in template manager.",
        ["DefaultStepName"] = "Step {0}",
        ...
        ["TrayStatusActive"] = "ServicePilot: {0}/{1} running, {2} failed | {3}",
